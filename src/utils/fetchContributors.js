...
var ORG_NAME = process.env.ORG_NAME || "kathFOSS-Club";
var REPO_NAME = process.env.REPO_NAME || "kathfoss-web";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    filePath = path.join(__dirname, "../../public/contributors.json");
                    fs.writeFileSync(filePath, JSON.stringify(contributorsDetails, null, 2) // Pretty-print JSON with 2 spaces
                    );
